...
import com.lijangop.sdk.widget.animatebutton.ei.Ease;
import com.lijangop.sdk.widget.animatebutton.ei.EasingInterpolator;

import java.util.Random;

/**
 * @Author lijiangop
 * @CreateTime 2020/8/20 10:29
 */
public class AnimateView extends View {
    ...
    public AnimateView(Context context, final AnimateButton shineButton, ShineParams shineParams) {
        super(context);
        ...
        shineAnimator.addListener(new Animator.AnimatorListener() {
            ...
            @Override
            public void onAnimationEnd(Animator animator) {
                shineButton.removeView(AnimateView.this);
            }
    ...
    public void showAnimation(AnimateButton shineButton) {
    ...
    private void initShineParams(ShineParams shineParams, AnimateButton shineButton) {
        ...
        if (bigShineColor == 0) {
            bigShineColor = shineButton.getFillColor();
        }
    }
}
