...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private boolean                 isNoAnimate = true;
    ...
    public void setCheckedColor(int unCheckedColor) {
        mCheckedColor = unCheckedColor;
    }

    public void setIsNoAnimate(boolean isNoAnimate) {
        this.isNoAnimate = isNoAnimate;
    }
     ...
     * @param canvas
     */
    private void drawTickPathNoAnimate(Canvas canvas) {
        // draw left of the tick
        mTickPath.reset();
        mTickPath.moveTo(mTickPoints[0].x, mTickPoints[0].y);
        mTickPath.lineTo(mTickPoints[1].x, mTickPoints[1].y);
