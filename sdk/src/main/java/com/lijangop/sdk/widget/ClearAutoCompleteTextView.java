...
import com.lijangop.sdk.utils.Gid;

/**
 * @Author lijiangop
 * @CreateTime 2020/6/12 10:08
 */
public class ClearAutoCompleteTextView extends android.support.v7.widget.AppCompatAutoCompleteTextView implements
    ...
    private void init(Context context) {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(Gid.getID(context, "R.drawable.ss_clear_selector"));
        }
